...
export default function PlayerSheetHpPersistent({ character }: PlayerSheetHpPersistentProps) {
  ...
  // Color: green > 50%, amber > 25%, red > 0%, gray at 0
    ...
    <div className="shrink-0 px-3 py-2 border-b border-gold/5 bg-obsidian/60 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-4 gap-1.5 mt-1.5">
        <button
          ...
          className="py-1.5 rounded-lg bg-red-500/15 border border-red-500/20 text-red-400 text-sm font-bold active:scale-95 transition-all duration-150 hover:bg-red-500/20"
        >
          -1
        </button>
        <button
          onClick={() => handleHpChange(-5)}
          className="py-1.5 rounded-lg bg-red-500/12 border border-red-500/15 text-red-400/80 text-sm font-bold active:scale-95 transition-all duration-150 hover:bg-red-500/15"
        >
          -5
        </button>
        <button
          onClick={() => handleHpChange(5)}
          className="py-1.5 rounded-lg bg-green-500/12 border border-green-500/15 text-green-400/80 text-sm font-bold active:scale-95 transition-all duration-150 hover:bg-green-500/15"
        >
          +5
        </button>
        <button
          onClick={() => handleHpChange(1)}
          className="py-1.5 rounded-lg bg-green-500/15 border border-green-500/20 text-green-400 text-sm font-bold active:scale-95 transition-all duration-150 hover:bg-green-500/20"
        >
          +1
        </button>
      </div>
      ...
      <div className="flex items-center gap-1.5 mt-1.5">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-gold-500/10 border border-gold/20 text-gold-400 text-[11px] font-semibold rounded-lg active:scale-95 transition-all duration-150 hover:bg-gold-500/15"
        >
          Apply
        </button>
      </div>
