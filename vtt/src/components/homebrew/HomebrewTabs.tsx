/**
 * STᚱ VTT — Homebrew Tabs (Premium Pill Indicator)
 *
 * Premium tab navigation for Items / Spells / Feats with gold pill indicator,
 * hover scale feedback, and consistent gold accent styling.
 */
...
export default function HomebrewTabs({ activeTab, onChange }: HomebrewTabsProps) {
  return (
    <div className="flex items-center gap-1.5 p-0.5 rounded-lg bg-[#0c0d15]/60 border border-white/[0.04]">
      {TABS.map((tab) => (
        <button
          key={tab.id}
