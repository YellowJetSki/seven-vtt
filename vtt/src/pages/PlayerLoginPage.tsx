/**
 * STᚱ VTT — Player Login Page (Premium Overhaul)
 *
 ...
 *
 * Premium Design:
 * - Legacy `glass-gold` → direct glass gradient with edge light
 * - Legacy `rogue-*` color tokens → gold/amber/emerald system
 * - Connection state indicator (Firebase sync status)
 * - Staggered entrance animations on all content
 * - Edge-lit glass card with multi-layer depth
 */
