/**
 * STᚱ VTT — Homebrew Panel (Premium 7-Layer Cinema Header)
 *
...
export default function HomebrewPanel() {
  return (
    <AppShell>
      <div className="mx-4 mt-4" style={{ maxWidth: "80rem", marginLeft: "auto", marginRight: "auto" }}>
        {/* ── 7-Layer Cinematic Hero Header (matching Battle Maps/Player Cards) ── */}
        ...
        {/* ── Content Area ── */}
        <div className="relative mt-4 sm:mt-6 rounded-xl bg-gradient-to-b from-[#141520]/90 to-[#0f1019]/95 border border-white/[0.04] overflow-hidden">
