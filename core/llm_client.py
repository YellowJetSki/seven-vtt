    ...
    def __init__(self, workspace_choice: str):
        ...
        if workspace_choice == "1":
            ...
            system_instruction = (
                ...
                "9. THE MANDATORY DEPLOYMENT PIPELINE: After completing the Dev and QA phases, you MUST execute the 'execute_production_deployment' tool. This safely locks the system, handles version control, waits for Vercel, and runs the final visual validation autonomously.\n"
