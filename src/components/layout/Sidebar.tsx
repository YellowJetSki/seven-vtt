...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-30 flex h-full flex-col border-r border-surface-700/80 bg-surface-850 transition-all duration-300 ease-out md:static md:z-auto ${
          sidebarOpen
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all ${
                  isActive
                    ? "bg-accent-500/12 text-accent-300 shadow-sm"
